...
Pod::Spec.new do |s|
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source       = { :git => "https://github.com/LP-Messaging/iOS-Messaging-SDK", :commit => "a0a5d70a31df59f7eeb8e43701c3c3e3bc3cd804" }


  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
    s.resource = "Libraries/LPMessagingSDKModels.bundle"
    s.ios.vendored_frameworks = 'Libraries/*.framework'
